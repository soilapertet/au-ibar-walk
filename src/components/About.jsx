    ...
    (
        <section className="section" id="about">
            <div className="section-inner">
                ...
                <p className="lead">The Awareness Walk is a people-centred platform to raise visibility around the importance of
